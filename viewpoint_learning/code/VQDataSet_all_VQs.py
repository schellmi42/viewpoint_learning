'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    \brief Code with dataset for ML learning
...
class VQDataSet(DataSet):
    ...
    def get_next_batch(self, repeatModelInBatch = False):
        ...
        return numModelInBatch, accumPts, accumFeatures, accumBatchIds, accumLabels, accumLabels_mult, accumSigns, accumModels, accumModelParams, accumAreas, accumReferenceValues, accumInvRotationMatrix, accumRotationMatrix, accumVQs
